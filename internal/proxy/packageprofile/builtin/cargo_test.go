...
func TestCargoProfileClassifiesSparseMetadataAndVersionedCrates(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "legacy versioned crate", host: "static.crates.io", path: "/crates/serde/serde-1.0.219.crate", class: packageprofile.ClassImmutable},
		{name: "live versioned crate", host: "static.crates.io", path: "/crates/itoa/1.0.11/download", class: packageprofile.ClassImmutable},
		{name: "live prerelease crate", host: "static.crates.io", path: "/crates/itoa/1.0.11-alpha.1+build.5/download", class: packageprofile.ClassImmutable},
		{name: "live latest crate", host: "static.crates.io", path: "/crates/itoa/latest/download", class: packageprofile.ClassUnknown},
		{name: "live incomplete version", host: "static.crates.io", path: "/crates/itoa/1.0/download", class: packageprofile.ClassUnknown},
		{name: "live version with leading zero", host: "static.crates.io", path: "/crates/itoa/01.0.0/download", class: packageprofile.ClassUnknown},
		{name: "live prerelease with leading zero", host: "static.crates.io", path: "/crates/itoa/1.0.0-01/download", class: packageprofile.ClassUnknown},
		{name: "live crate with extra segment", host: "static.crates.io", path: "/crates/itoa/1.0.11/download/extra", class: packageprofile.ClassUnknown},
		{name: "legacy crate with malformed version", host: "static.crates.io", path: "/crates/serde/serde-latest.crate", class: packageprofile.ClassUnknown},
